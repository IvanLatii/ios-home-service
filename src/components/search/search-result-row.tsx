...
interface SearchResultRowProps {
  label: string;
  href: string;
  /** Substring to highlight in pink (case-insensitive). */
  highlight?: string;
}

/** A single service row in the "Services" results list — always navigates. */
export function SearchResultRow({ label, href, highlight }: SearchResultRowProps) {
  return (
    <Link
      href={href}
